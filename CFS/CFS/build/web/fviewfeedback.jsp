...
<div class="wrapper">
  ...
  <center>
   ...
   <%
        ...
        String query="select distinct collegename from feedback "; 
        ...
        <%                while (rs.next()) {
            String query1="select * from feedback where collegename = '"+rs.getString(1)+"'" ; 
        ...
        <th><font color="black">College Name</th>
        <th><font color="black">Studies</th>
        <th><font color="black">Sports</th>
        <th><font color="black">Placements</th>
