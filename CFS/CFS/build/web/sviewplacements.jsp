...
<div class="wrapper">
  ...
  <div class="menu">
    <ul>
      ...
      <li><a href="sviewplacements.jsp" class="active">View Placements</a></li>
  ...
  <div class="header">
    ...
    <div class="header-button"><a href="#">View Placements</a> </div>
  ...
  <center>
   ...
   try{    
    ...
    rs=st.executeQuery("select * from placements where collegename = '"+cname+"'");
    ...
    <center>
         ...
         while(rs.next()){
          ...
          <th><%=rs.getString("company")%></th>  
          <th><%=rs.getString("about")%></th>
